<template>
  <div>
    <div class="bg-purple" style="height:570rpx"></div>
    ...
    <div class="msg-wrap bg-white radius shadow padding-lr-sm">
      <form>
        ...
        <view class="cu-form-group">
          <textarea maxlength="-1" :disabled="modalName!=null" @input="textareaAInput" placeholder="输入详情"></textarea>
        </view>
      ...
      <div class="cu-btn bg-purple block radius">提交</div>
    </div>
  </div>
</template>
